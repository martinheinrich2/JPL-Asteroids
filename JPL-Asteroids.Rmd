...
```{r log-scale plot1, warning=FALSE}
...
```{r plot artefacts, warning=FALSE}
...
```{r plot without artefacts, warning=FALSE}
...
```{r aphelion and perihelion, warning=FALSE}
a <- seq(0.1, 20, 0.01)
...
```{r inclination plot, warning=FALSE}
...
```{r heatmap binning, warning=FALSE}
